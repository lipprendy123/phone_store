  ...
  return (
    ...
    <div className="container max-w-[1130px] mx-auto flex flex-1 items-center justify-center py-5">
        <form action={formAction} className="w-[500px] bg-white p-[50px_30px] flex flex-col gap-5 rounded-3xl border border-[#E5E5E5]">
            ...
            <h1 className="font-bold text-2xl leading-[34px] text-gray-900">Sign In</h1>
            ...
            <div className="flex flex-col gap-3">
                <SubmitButton/>
                <Link href="/sign-up" className="p-[12px_24px] bg-white rounded-full text-center font-semibold border text-gray-600 border-[#E5E5E5]">Sign Up</Link>
            </div>
        </form>
    </div>
</div>
