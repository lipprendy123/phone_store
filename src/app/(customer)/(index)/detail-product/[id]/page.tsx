    ...
    <>
      ...
      >
        <div className="flex flex-col gap-5">
          ...
          <h1 className="font-bold text-4xl leading-9 text-gray-800">
            {product.name}
          </h1>
        </div>
        <div className="flex items-center gap-2 justify-end">
          ...
          <p className="font-semibold text-gray-800">({product._count.orders})</p>
        </div>
      </div>
      ...
      <div
        ...
        <div className="flex items-center gap-[10px]">
          ...
          <p className="font-semibold text-sm text-gray-800 text-white">
      ...
      <div
        id="details-info"
        className="container max-w-[1030px] mb-20 mx-auto flex justify-between gap-5 mt-[50px]"
      >
        <div className="max-w-[650px] w-full flex flex-col gap-[30px]">
          <div id="about" className="flex flex-col gap-[10px]">
            <h3 className="font-semibold  text-white">About Product</h3>
            <p className="leading-[32px]  text-white">
             {product.description}
            </p>
          </div>
          <div id="testi" className="flex flex-col gap-[10px]">
            <h3 className="font-semibold  text-white">Real Testimonials</h3>
            <div className="grid grid-cols-2 gap-5">
              <div className="testi-card flex flex-col bg-white p-5 gap-5 border border-[#E5E5E5] rounded-[20px] h-fit">
                ...
                <p className="line-clamp-2 hover:line-clamp-none leading-[28px]  text-gray-800">
                ...
                <div className="flex items-center gap-[10px]">
                  ...
                  <div className="flex flex-col gap-[2px]">
                    <p className="font-semibold text-sm leading-[22px]  text-gray-600">
                      Angga Risky
                    </p>
