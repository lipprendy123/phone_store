...
import ListCategory from './_components/list-categoy'
    ...
    <div className="container max-w-[1130px] mx-auto flex items-center justify-between gap-1 mt-[50px]">
        <div className="flex flex-col gap-[30px]">
            <div className="flex items-center gap-[10px] p-[8px_16px] rounded-full bg-white w-fit">
                ...
                <p className="font-semibold text-sm text-gray-700">Most Popular 100th Product in Belanja</p>
            </div>
            <div className="flex flex-col gap-[14px]">
                <h1 className="font-bold text-[55px] leading-[55px] text-gray-800">Working Faster 10x</h1>
            ...
            <div className="flex items-center gap-3">
                ...
                <a href="" className="p-[18px_24px] rounded-full font-semibold bg-white text-gray-700">View Details</a>
            </div>
        </div>
        <div className="w-[588px] h-[360px] flex shrink-0 overflow-hidden relative">
            ...
            <div className="absolute top-[60%] bg-white p-[14px_16px] rounded-3xl flex items-center gap-[10px]">
                ...
                <p className="font-semibold text-sm text-gray-700">Bonus Mac OS <br/> Capitan Pro</p>
            </div>
            <div className="absolute right-0 top-[30%] bg-white p-[14px_16px] rounded-3xl flex flex-col items-center gap-[10px]">
                ...
                <p className="font-semibold text-sm text-center text-gray-700">Include <br/> Warranty</p>
            </div>
        </div>
    </div>
    <div className="container max-w-[1130px] mx-auto flex items-center justify-center gap-10 mt-[50px]">
        <div className="flex items-center gap-[10px]">
            ...
            <div className="flex flex-col gap-[2px]">
                <p className="font-semibold text-sm leading-[22px] text-gray-800">Awesome product!</p>
                <p className="text-xs leading-[18px] text-gray-600">Jemmie Pemilia</p>
            </div>
        </div>
        <div className="flex items-center gap-[10px]">
            <div className="w-[50px] h-[50px] flex shrink-0 rounded-full border-[5px] border-white overflow-hidden">
            ...
            <div className="flex flex-col gap-[2px]">
                <p className="font-semibold text-sm leading-[22px] text-gray-800">Money saver 25%</p>
                <p className="text-xs leading-[18px] text-gray-600">Angga Risky</p>
            </div>
        </div>
        <div className="flex items-center gap-[10px]">
            <div className="w-[50px] h-[50px] flex shrink-0 rounded-full border-[5px] border-white overflow-hidden">
            ...
            <div className="flex flex-col gap-[2px]">
                <p className="font-semibold text-sm leading-[22px] text-gray-800">I love the warranty</p>
                <p className="text-xs leading-[18px] text-gray-600">Petina Malaka</p>
            </div>
        </div>
        <div className="flex items-center gap-[10px]">
            <div className="w-[50px] h-[50px] flex shrink-0 rounded-full border-[5px] border-white overflow-hidden">
            ...
            <div className="flex flex-col gap-[2px]">
                <p className="font-semibold text-sm leading-[22px] text-gray-800">Big deals ever!</p>
                <p className="text-xs leading-[18px] text-gray-600">Udin Sarifun</p>
            </div>
        </div>
    </div>
</header>
