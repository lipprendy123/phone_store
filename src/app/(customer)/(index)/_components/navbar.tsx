  ...
  return (
    ...
    <div className="flex items-center gap-3">
       ...
       {session && user.role === 'customer' ? (
        ...
        <>
             <Link href="/sign-in" className="p-[12px_20px] text-gray-700 bg-white rounded-full font-semibold">
            Sign In
        </Link>
        <Link href="/sign-up" className="p-[12px_20px] text-gray-700 bg-white rounded-full font-semibold">
            Sign Up
        </Link>
        </>
       )}
