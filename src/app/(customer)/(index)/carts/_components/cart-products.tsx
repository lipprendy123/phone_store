    ...
    {products.map((cart) => (
         ...
         <div className="flex items-center w-[340px] gap-5">
             ...
             <div className="flex flex-col gap-1">
                 <p className="font-semibold leading-[22px] text-gray-800">{cart.name}</p>
         ...
         <button type='button' onClick={() => removeProduct(cart.id)} className="p-[12px_24px] bg-white rounded-full text-center font-semibold border text-gray-800 border-[#E5E5E5]">Remove</button>
     </div>
    ))}
    </div>
  )
