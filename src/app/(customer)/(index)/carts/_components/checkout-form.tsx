...
function SubmitButton() {
    ...
    return (
        <button type='submit' disabled={pending}  className="p-[12px_24px] bg-[#0D5CD7] rounded-full text-center font-semibold text-gray-800">{pending ? 'Checkout with xendit...' : 'Checkout Now'}</button>
    )
}
        ...
        <div className="w-full bg-white border border-[#E5E5E5] flex flex-col gap-[30px] p-[30px] rounded-3xl">
                ...
                <div className="w-full bg-white border border-[#E5E5E5] flex items-center justify-between gap-2 p-5 rounded-3xl">
                    <div className="flex items-center gap-[10px]">
                        ...
                        <div className="flex flex-col gap-[2px]">
                            <p className="font-semibold text-gray-800">100% Its Original</p>
                            <p className="text-sm  text-gray-800">We dont sell fake products</p>
                        </div>
                    </div>
                    <div className="flex shrink-0">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                    ...
                    <p className="font-semibold  text-gray-800">{rupiahFormat(grandTotal)}</p>
                </div>
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <div className="flex shrink-0">
                    ...
                    <p className="font-semibold  text-gray-800">Rp 0</p>
                </div>
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <div className="flex shrink-0">
            ...
            <div className="flex flex-col gap-1">
                ...
                <p className="font-bold text-[32px] leading-[48px]  text-gray-800 underline text-[#0D5CD7]">{rupiahFormat(grandTotal)}</p>
            </div>
            <div className="flex flex-col gap-3">
                <SubmitButton/>
                <a href="" className="p-[12px_24px] bg-white rounded-full text-center font-semibold border border-[#E5E5E5]  text-gray-800">Contact Sales</a>
            </div>
        </div>
